...
List<Users> UsersList = [
  Users('User', 'Status', 'Phone Number', 'Position', 'Department', 'Activity',
      false),
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Container(
                                  width: width * 0.1,
                                  child: Text(
                                      UsersList[index].position.toString()))),
                          Expanded(
                              child: Container(
                                  child: Text(
                                      UsersList[index].department.toString()))),
                          Expanded(
                              child: Container(
                                  width: width * 0.1,
                                  child: Text(
                                      UsersList[index].activity.toString()))),
